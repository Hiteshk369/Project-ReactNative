  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.buttonRight}>
        <TouchableOpacity
          onPressIn={() => navigation.navigate('HabitHistory')}
          ...
          />
          <Text style={styles.bottomButtonText}>Habit History</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPressIn={() => navigation.navigate('Immunization')}
          style={styles.bottomButtonBackground}>
          <Text style={styles.bottomButtonText}>Immunization</Text>
          <AntDesign
            name="doubleright"
            color={Colors.lightPurple}
            style={styles.rightArrow}
